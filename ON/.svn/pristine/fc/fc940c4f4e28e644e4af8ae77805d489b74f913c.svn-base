...
public class FundingVO {
	...
	private String fundingThumbNailPath;
	...
	public String getFundingThumbNailPath() {
		return fundingThumbNailPath;
	}
	public void setFundingThumbNailPath(String fundingThumbNailPath) {
		this.fundingThumbNailPath = fundingThumbNailPath;
	}
	...
	public String toString() {
		...
		String msg = "toString:: fundingId =" + this.fundingId + 
				 ...
				 ", fundingThumbPath=" + this.fundingThumbNailPath +
