...
<%-- 			<td><%= noticeList.get(i).getAtchId() %></td> --%>
			...
			<td><a href="#" type="button" class="btn btn-warning">수정</a></td>
<%-- 			<td><a href="<%request.getContextPath()%>/deleteNotice.do?noticeId=<%= noticeList.get(i).getNoticeId() %>" type="button" class="btn btn-danger">삭제</a></td> --%>
			<td><a href="<%=request.getContextPath()%>/deleteNotice.do?noticeId=<%=noticeList.get(i).getNoticeId()%>" class="btn btn-warning">삭제</a></td>
		</tr>
<%
		}
...
%>		
  ...
  <a href="#" type="button" class="btn btn-default" align="center">글 등록</a>
