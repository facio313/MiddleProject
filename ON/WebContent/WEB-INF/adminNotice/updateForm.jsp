		...
		<form action="/UpdateNoticeController.do" method="post" enctype="multipart/form-data">
			...
			<div class="row">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" name="noticeTitle" value="<%=nv.getNoticeTitle()%>">
				  </div>
				  <div class="form-group">
				    <label for="content">내 용</label>
				    <input type="text" class="form-control" name="noticeContent" value="<%=nv.getNoticeContent()%>" style="height:200px">
				  </div>
