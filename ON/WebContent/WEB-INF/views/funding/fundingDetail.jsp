        	...
        	<form id="fundingForm" action="<%=request.getContextPath() %>/funding/Update.do" method="post">
        		...
        		<table>
					...
					<tr>
						<td>후원타이틀:</td>
						<td>
							<input type="text" name="fundingTitle" value="<%= fundingDetail.getFundingTitle() %> ">
						</td>
					</tr>
					<tr>
						<p>후원기관 : <%= fundingDetail.getMemId() %></p>
					</tr>
					<tr>
						<td>목표금액 : </td>
						<td>
							<input type="text" name="targetAmount" value="<%= fundingDetail.getTargetAmount() %> ">
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>계좌번호:</td>
						<td><input type="text" name="fundingAccount" value="<%= fundingDetail.getFundingAccount() %> "></td>
					</tr>
					<tr>
						<td>예금주:</td>
						<td><input type="text" name="fundingAccountHolder" value="<%= fundingDetail.getFundingAccountHolder() %> "></td>
					</tr>
					<tr>
						<td>은행명:</td>
						<td><input type="text" name="fundingBankName" value="<%= fundingDetail.getFundingBankName() %> "></td>
					</tr>
					<tr>
						<td><p>후원상세내용 : </p></td>
						<td>
							<textarea id="fundingDetail" name="fundingDetail" rows="" cols=""><%= fundingDetail.getFundingDetail() %></textarea>
						</td>
					</tr>
					</table>
					<input type="text" class="btn btn-success" onclick="fnUpdateFunding();" value="수정하기">
		     ...
		     <form id="donateForm" action="<%=request.getContextPath() %>/donate/Donate.do" method="post">
		     	 ...
		     	 <input type="hidden" id="donateBankName" name="fundintId" value="<%= fundingDetail.getFundingId() %>">
      			 <table>
					...
					<tr>
						<td>후원타이틀:</td>
						<td><%= fundingDetail.getFundingTitle() %></td>
					</tr>
					<tr>
						<p>후원자아이디 : <%= fundingDetail.getMemId() %></p>
					</tr>
					<tr>
					...
					<tr>
						<td><p>후원기간 : <%= fundingDetail.getFundingStartDate() %> -  <%= fundingDetail.getFundingEndDate() %></p></td>
					</tr>
					<tr>
						<td><p>후원상세내용 : <%= fundingDetail.getFundingDetail() %></p></td>
					</tr>
					<tr>
						<input type="textarea" name="donateAmount" id="donateAmount" value="금액" />원
